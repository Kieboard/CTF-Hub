...
- **Localisation is a deliberate social engineering tactic.** Sending in German adds perceived legitimacy for German-speaking targets and may reduce suspicion from non-native speakers who assume it's simply a regional message.
