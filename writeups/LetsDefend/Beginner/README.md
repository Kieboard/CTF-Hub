...
| <img src="Malicious-AutoIT/MaliciousAutoIT.png" width="32" alt="Malicious AutoIT"> | [Malicious AutoIT](../Malicious-AutoIT/Malicious-AutoIT.md) | Beginner | `#letsdefend` `#beginner` `#challenge` `#malware` `#reversing` `#dfir` | Apr 21, 2026 |
| <img src="PCAP-Analysis/PCAPAnalysis.png" width="32" alt="PCAP Analysis"> | [PCAP Analysis](../PCAP-Analysis/PCAP-Analysis.md) | Beginner | `#letsdefend` `#beginner` `#challenge` `#network-forensics` `#pcap-analysis` `#wireshark` | Apr 21, 2026 |
