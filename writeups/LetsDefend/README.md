...
| Icon | Lab | Tags | Date |
| ---- | --- | ---- | ---- |
| <img src="Beginner/Phishing-Email/PhishingEmail.png" width="32" alt="Phishing Email"> | [Phishing Email](Beginner/Phishing-Email/Phishing-Email.md) | `#challenge` `#phishing` `#email-analysis` `#osint` | Apr 15, 2026 |
